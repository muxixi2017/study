...
public class MxxGLActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FrameLayout.LayoutParams lp = new FrameLayout.LayoutParams(512, 512);
...
////                if (mSurfaceView.mRenderer.mShape != null) {
////                    if (--MxxShape.beautyLevel <= 0) {
////                        MxxShape.beautyLevel = 5;
////                    }
////                    //mSurfaceView.mRenderer.mShape.setBeautyLevel(MxxShape.beautyLevel);
////                }
//            }
//        });
