package com.bzsample.mxxgldemo.sample09;
...
public class MxxShape {
    ...
    private static final String mFragmentShaderCode =
            "precision mediump float;" +
                  ...
                  // (2) 2image alpha
                    "    gl_FragColor = (1.0 - u_alpha) * l_Color1 + l_Color2 * u_alpha;" +
                  // (3) gray
    ...
    public void draw(float[] mvpMatrix) {
        ...
        int alphaHandle = GLES20.glGetUniformLocation(mProgram, "u_alpha");
        float time = System.currentTimeMillis() % 4000L;
        float alpha = time / 4000.0f;
        setFloat(alphaHandle, alpha);
