package com.bzsample.mxxgldemo.sample10;
...
public class MxxShape {
    ...
    public MxxShape(MxxContext context) {
        ...
        int vertexShader = MxxUtils.loadShader(GLES20.GL_VERTEX_SHADER, context.readShaderCodeFromResource(R.raw.vertex_shader_10));
        int fragmentShader = MxxUtils.loadShader(GLES20.GL_FRAGMENT_SHADER, context.readShaderCodeFromResource(R.raw.fragment_shader_10));
